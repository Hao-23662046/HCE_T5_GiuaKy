...
export default function CartPage() {
  const {
    ...
    increaseQuantity,
    decreaseQuantity,
    clearCart, // Thêm clearCart từ context để xóa giỏ hàng sau khi thanh toán
  } = useCart();
  ...
  // Xử lý thanh toán khi nhấn nút "Thanh toán ngay"
  const handlePayment = () => {
    // Thực hiện thanh toán (có thể tích hợp API thanh toán như Stripe ở đây)
